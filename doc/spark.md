...
The best configuration files with best configurations are [spark-default.conf]() and [spark-env.sh](https://github.com/zhuyuqing/bestconf/blob/master/bestconfs/spark/bestconfForPagerank/spark-env.sh).
Script files
--------
